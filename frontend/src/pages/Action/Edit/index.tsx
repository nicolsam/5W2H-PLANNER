...
import { Alert, AlertTitle, Box, Button, Chip, CircularProgress, FormControl, FormHelperText, InputAdornment, InputLabel, MenuItem, OutlinedInput, Select, SelectChangeEvent, Stack, TextField } from "@mui/material";
            ...
            >
                <Stack spacing={3} direction={'column'}>
                    ...
                    <Stack spacing={1} direction={'column'}>
                        ...
                        />
                        {contextAreas.find((item) => item.attributes.name === action?.attributes?.area) === undefined && (
                            <Alert severity="warning">
                                <AlertTitle>A área selecionada não está disponível ou foi removida. Por gentileza, atualize a área desta ação.</AlertTitle>
                            </Alert>
                        )}  
                    </Stack>
